...
public class CellImpl implements Cell {
    ...
    /** The cell's local variables */
    private HashMap<String,Value> tempVariablesList = new HashMap();
...
*/
    ...
    /**
     * Set a new variable in the HashMap tempVariableList or replace
     * her value if exists.
     * @param name name of the variable
     * @param value value of variable
     */
    public void setVarValue(String name, Value value) {
        if (tempVariablesList.containsKey(name)) {
            tempVariablesList.replace(name, value);
        } else {
            tempVariablesList.put(name, value);
        }
    }
    
    /**
     * retrive the list of temporary variables
     * @return the list of temporary variables of a cell
     */
    public HashMap<String,Value> getTempVariablesList(){
        return tempVariablesList;
    }
    
    
    
    /**
     * notifys if style changed
     */
    public void fireStyleChanged(){
        for (CellListener listener : listeners)
                    listener.styleChanged(this);
        for (CellExtension extension : extensions.values())
                    extension.styleChanged(this);
    }
