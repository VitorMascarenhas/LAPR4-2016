...
public interface ExpressionVisitor {
	...
	/**
	 * Visits the given literal.
	 * @param literalCurrency the literalCurrency to visit
	 * @return an arbitrary object
	 */
	public Object visitLiteralCurrency(LiteralCurrency literalCurrency);

	/**
	 * Visits the given global variable.
	 * @param variable the global variable to visit
	 * @return an arbitrary object
	 */
	public Object visitGlobal(GlobalVariable variable);
}