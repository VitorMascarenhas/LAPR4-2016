 ...
 */
public class CellReference implements Reference, Assignable {
	...
	public void assignValue(Value newValue) throws IllegalValueTypeException {
		try {
			getCell().setContent(newValue.toString());
		} catch (FormulaCompilationException e) {
			e.printStackTrace();

			throw new IllegalValueTypeException(newValue, Value.Type.UNDEFINED);
		}
	}
}