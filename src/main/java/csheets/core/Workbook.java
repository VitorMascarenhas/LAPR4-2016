...
public class Workbook implements Iterable<Spreadsheet>, Serializable {
	...
	/** The manager that handles all the workbook global variables */
	 ...
	 * @param spreadsheet spreadsheet
	 */
	public void renameSpreadsheet(Spreadsheet spreadsheet) {

		fireSpreadsheetRenamed(spreadsheet);
	}
	...
	public Iterator<Spreadsheet> iterator() {
        ...
        public int indexOfSpreadsheet(Spreadsheet spreadsheet){
            return this.spreadsheets.indexOf(spreadsheet);
        }

	/**
	 * TODO
	 */
	public GlobalVariable addGlobalVar(String name) {
		return this.globalVariableManager.addVariable(name);
	}
 ...
 */
	...
	private void fireSpreadsheetRenamed(Spreadsheet spreadsheet) {
        ...
        public void renamedSpreadsheet(Spreadsheet spreadsheet){
            fireSpreadsheetRenamed(spreadsheet);
        }
/*
 * GENERAL
