...
public class ExtensionManager {
    ...
    private ExtensionManager() {
        ...
        File userProprietes = new File(System.getProperty("user.home")
        ...
        if (!userProprietes.exists()) {
            ...
            boolean result = loadUserExtensions(userProprietes);
            
            if(!result){
                System.out.println("Cannor load extensions.props from user profile!");
            }
    ...
    /**
     * Load user extensions.props
     * @param userProprietes
     * @return 
     */
    
    private boolean loadUserExtensions(File userProprietes) {
        
        Properties extProps = new Properties();
        InputStream stream = CleanSheets.class.getResourceAsStream(System.getProperty("user.home")
            + "/cleansheet/" + PROPERTIES_FILENAME);
        if (stream != null) {
            try {
                extProps.load(stream);
