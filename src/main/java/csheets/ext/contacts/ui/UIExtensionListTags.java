...
/**
 * This class implements the UI interface extension for the ListTags extension.
 * A UI interface extension must extend the UIExtension abstract class.
 * @see UIExtension
 * @author José Vilela 1010500
 * @author Einar Pehrson
 */
public class UIExtensionListTags extends UIExtension {
...
//	private ExampleMenu menu;
	public UIExtensionListTags(Extension extension, UIController uiController) {
	...
	public Icon getIcon() {
		if (icon == null)
			icon = new ImageIcon(
				ListTagsExtension.class.getResource("res/img/logo.png"));
		return icon;
	}
