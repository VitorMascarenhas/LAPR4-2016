...
/**
 * This class implements the UI interface extension for the Extension Manager
...
public class UIExtensionManager extends UIExtension {
	...
	private ExtensionManagerMenu menu;
	 ...
	 * @see ExtensionManagerMenu
	 * @return a JMenu component
	 */
        @Override
	public JMenu getMenu() {
		if (menu == null)
			menu = new ExtensionManagerMenu(uiController);
		return menu;
	}
