 ...
 * </p>
 * <p>
 * It should be possible to send the contents of a range of cells to another instance of Cleansheets. The other instance should display the received contents in the same cell address as the original cells. 
 * </p>
 * <p>
 * It should be possible to configure the port to be used for network connections. 
 * </p>
 * It should be possible to find other instances of Cleansheets available in e local network. These instances should be listed in a new window (sidebar window). 
 * 
 * The user should be able to select one of the discovered instances to connect to when establishing the connection to send the contents of the range of cells. 
 * 
 * <p>
 ...
 * 
 * <h2>3. Requirement</h2>
 * Setup extension for start sharing cells with other instance of Cleansheets in the local network. The user should be able to activate and deactivate sharing. When activated, a sidebar with avaliable servers appear.The sidebar should be composed of a JList of RemoteInstances and two buttons, connect/disconnect button to connect or disconnect to the RemoteInstance selected and send button to send a cell value to the RemoteInstance connected. At the moment it is only required to send the value of the cells.
 * <p>
 * <b>Use Case "Start Sharing":</b> The user activate startSharing. The system display the sidebar with avaliable RemoteInstances. The User selects the RemoteInstance where he/she wants to send a value of cell(s) and click connect. If the connection is sucessful the system show the send button. The User selects the cell(s) that he/she wants to send to RemoteInstance and click the send button. The RemoteInstance receive the value of cell(s) and update his owns cell(s).
 *  
 * <h2>4. Analysis</h2>
 * 
 * 
 ...
 * The following diagram shows the setup of the "StartSharing" extension when cleansheets is run.
 * <p>
 * <img src="doc-files/ipc01_01_design_01.png" alt="image4">
 *
 * <h3>User Activate StartSharing</h3>
 * The following diagram illustrates what happens when the user Activate the StartSharing Menu. The idea is that when this happens the extension must display in the sidebar the list of avaliable servers (if they exist).
 * <p>
 * <img src="doc-files/ipc01_01_design_02.png" alt="image5">
 * 
 * <h3>UdpServer Sequence Diagram</h3>
 * The following diagram illustrates the process of listening for another instances of Cleansheets over the network.
 * <p>
 * <img src="doc-files/ipc01_01_design_03.png" alt="image6">
 * 
 * <h3>UdpClient Sequence Diagram</h3>
 * The following diagram illustrates the process of finding another instances of cleansheets.
 * <p>
 * <img src="doc-files/ipc01_01_design_04.png" alt="image7">
 * 
 * <h3>5.3. Classes</h3>
 * 
...
package csheets.worklog.n1010500.sprint1;
class _Dummy_ {}