 ...
 * @author smoli
 */
public class UIExtensionSendChatMessage extends UIExtension{
    ...
    public UIExtensionSendChatMessage(Extension extension, UIController uiController) {
    ...
    public JComponent getSideBar() {
        if (sideBar == null) {
            sideBar = new SendChatMessagePanel(uiController);
        }
        return sideBar;
    }
