 ...
 * @author ASUS
 */
public class UIExtensionSendChatParticipants extends UIExtension{
    ...
    public UIExtensionSendChatParticipants(Extension extension, UIController uiController) {
    ...
    public JComponent getSideBar() {
        if (sideBar == null) {
            sideBar = new SendChatParticipantsPanel(uiController);
        }
        return sideBar;
    }
