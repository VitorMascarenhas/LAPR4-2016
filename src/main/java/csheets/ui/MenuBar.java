...
import csheets.lang.files.ui.ExportFileAction;
import csheets.lang.files.ui.ImportFileAction;
...
public class MenuBar extends JMenuBar {
	...
	public MenuBar(CleanSheets app, ActionManager actionManager, UIController uiController) {
		...
		fileMenu.add(actionManager.getAction("saveas"));
                ...
                //1121060 Lang08.3- Full XML Import/Export
		//fileMenu.add(new ExportFileAction(app, uiController));
                //fileMenu.add(new ImportFileAction(app, uiController));
                JMenu importExportMenu = addMenu("Import/Export", KeyEvent.VK_I);
                importExportMenu.add(new ExportFileAction(app, uiController));
                importExportMenu.add(new ImportFileAction(app, uiController));
		...
		editMenu.add(actionManager.getAction("selectall"));
                // 1121060 Sérgio Oliveira Core03.2
		//editMenu.add(actionManager.getAction("sort"));
                editMenu.add(actionManager.getAction("sorta"));
                editMenu.add(actionManager.getAction("sortd"));
