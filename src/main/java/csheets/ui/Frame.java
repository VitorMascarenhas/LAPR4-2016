...
import csheets.ipc.findworkbooks.ui.UIExtensionFindWorkbooks;
...
public class Frame extends JFrame implements SelectionListener {
	...
	public Frame(CleanSheets app) {
		...
		actionManager.registerAction("print", new PrintAction());
                //adicionei 1950689 Nuno Mota
//                actionManager.registerAction("OpenWorkbookAction", new OpenWorkbookAction(app, uiController));
		...
		actionManager.registerAction("prefs", new PreferencesAction());
                ...
                actionManager.registerAction("sorta", new SortAscendingAction());
                actionManager.registerAction("sortd", new SortDescendingAction());
		...
		for (UIExtension extension : uiController.getExtensions()) {
                    if(extension.getExtension().getName().equalsIgnoreCase("FindWorkbooksExtension")){
                        
                        UIExtensionFindWorkbooks uiefw = (UIExtensionFindWorkbooks)extension;
                        uiefw.setAction(new OpenWorkbookAction(app, uiController));
                    }
