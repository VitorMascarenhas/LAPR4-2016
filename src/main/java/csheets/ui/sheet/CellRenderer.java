...
public class CellRenderer extends DefaultTableCellRenderer
{
    ...
    /**
     * Creates a new cell renderer for testing purpose.
     */
    CellRenderer() {}
                ...
                for (CellListener cellListner : this.cell.getCellListeners()) {
                    if (cellListner instanceof CommentableCell) {
                        ...
                        if (commentableCell.hasComment()) {
                            ...
                            int size = commentableCell.returnAllComments().size();
                            for(int i = 0; i < size;i++) {
                                str.append("<html>").append(commentableCell.returnAllComments().get(i).toString().replace("\n", "<br>")).append("</html>");
                            }
